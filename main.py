...
@app.post("/inference/")
async def inference(inference: RequestItem, response_model: PredictionResponse):
    try:
        ...
        # Preprocess the data
        df_prepared, y, encoder, lb = process_data(df_ordered, categorical_features=cat_features, label=None, training=False, encoder=encoder, lb=lb)
